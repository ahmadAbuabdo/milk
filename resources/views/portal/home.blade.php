...
@section('content')
    ...
    <section id="feature" >
        <div class="container">
           <div class="center wow fadeInDown">
            ...
            <div class="row">
                <div class="features">
                    <div class="col-md-12 col-sm-10 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                       <img class="img-responsive wow fadeInDown" src="{{ asset('/files/about_us/' . $aboutus->id . '/' . $aboutus->image) }}" alt="{{ $aboutus->name }}" >
                    </div><!--/.col-md-4-->
    ...
    <section id="partner">
        <div class="container">
            ...
            <div class="partners">
                <ul>
                    <li> <a href="#"><img class="img-responsive wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" src="/images/images/partners/wfp-logo.png"></a></li>
